...
//   // Filter each page's keys by the query
//   const filtered = useMemo(() => {
//     return pages
//       .map((pg) => {
//         const matches = Object.keys(pg.selectors || {}).filter((key) =>
//           key.toLowerCase().includes(query.toLowerCase())
//         );
//         return { pageName: pg.name, keys: matches };
//       })
//       .filter((pg) => pg.keys.length > 0);
//   }, [pages, query]);
...
//           ) : (
//             filtered.map((pg) => (
//               <div key={pg.pageName} className="mb-3">
//                 <div className="font-medium">{pg.pageName}</div>
